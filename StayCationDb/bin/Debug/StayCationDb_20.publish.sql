...
GO
ALTER TABLE [dbo].[PictureDb] ALTER COLUMN [hotelDescription] VARCHAR (300) NULL;

ALTER TABLE [dbo].[PictureDb] ALTER COLUMN [hotelGroup] VARCHAR (200) NULL;

ALTER TABLE [dbo].[PictureDb] ALTER COLUMN [hotelPopularity] VARCHAR (200) NULL;

ALTER TABLE [dbo].[PictureDb] ALTER COLUMN [IsPopular] VARCHAR (20) NULL;
